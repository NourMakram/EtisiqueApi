...
namespace EtisiqueApi.Migrations
{
    ...
    [Migration("20240906022358_update_apertment_services")]
    partial class update_apertment_services
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EcommercePro.Models.Contract", b =>
                {
                    b.HasOne("EcommercePro.Models.Project", "Project")
                        .WithOne("Contract")
                        .HasForeignKey("EcommercePro.Models.Contract", "projectId")
            ...
            modelBuilder.Entity("EtisiqueApi.Models.ApartmentSubServicesRequest", b =>
                {
                    ...
                    b.HasOne("EtisiqueApi.Models.ApartmentServicesRequest", "ApartmentServicesRequest")
                        .WithMany("SubServices")
                        .HasForeignKey("RequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ApartmentServicesRequest");
