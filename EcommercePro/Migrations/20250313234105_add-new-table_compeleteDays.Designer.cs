...
namespace EtisiqueApi.Migrations
{
    ...
    [Migration("20250313234105_add-new-table_compeleteDays")]
    partial class addnewtable_compeleteDays
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommercePro.Models.UserProject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EtisiqueApi.Models.ApartmentServicesVerifications", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ApartmentServicesVerifications");
                });
            ...
            modelBuilder.Entity("EtisiqueApi.Models.Attchments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("RequestManagementId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EtisiqueApi.Models.CommonPartsVerifications", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CommonPartsVerifications");
                });

            modelBuilder.Entity("EtisiqueApi.Models.Complaint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ComplaintIssueFile")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EtisiqueApi.Models.CompleteDays", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EtisiqueApi.Models.Customer", b =>
                {
                    ...
                    b.Property<DateOnly?>("GuaranteeEnd")
                        .HasColumnType("date");

                    b.Property<DateOnly?>("GuaranteeStart")
                        .HasColumnType("date");

                    b.Property<bool>("IsReceived")
                        .HasColumnType("bit");

                    b.Property<string>("ReceivedCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EtisiqueApi.Models.DaysOff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EtisiqueApi.Models.Emergency", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EtisiqueApi.Models.EmergencyTypes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EtisiqueApi.Models.ProjectImages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EtisiqueApi.Models.Questionnaire", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EtisiqueApi.Models.RequestsCommonParts", b =>
                {
                    ...
                    b.Property<string>("TimeElapsedClose1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TimeElapsedClose2")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EtisiqueApi.Models.RequestsImages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("KitchenServicesid")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("KitchenServicesid");

                    b.HasIndex("RequestsCommonPartsid");

                    b.ToTable("RequestsImages");
                });

            modelBuilder.Entity("EtisiqueApi.Models.Rule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EtisiqueApi.Models.Shrt", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("EtisiqueApi.Models.TechnicianQusetions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommercePro.Models.UserProject", b =>
                {
                    b.HasOne("EcommercePro.Models.ApplicationUser", "ManageBy")
            ...
            modelBuilder.Entity("EtisiqueApi.Models.ApartmentServicesVerifications", b =>
                {
                    b.HasOne("EcommercePro.Models.ApplicationUser", "Approver")
                        .WithMany()
                        .HasForeignKey("ApproverID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EtisiqueApi.Models.ApartmentServicesRequest", "Request")
                        .WithOne("ApartmentServicesVerifications")
                        .HasForeignKey("EtisiqueApi.Models.ApartmentServicesVerifications", "RequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EtisiqueApi.Models.Attchments", b =>
                {
                    b.HasOne("EtisiqueApi.Models.RequestManagement", "RequestManagement")
            ...
            modelBuilder.Entity("EtisiqueApi.Models.CommonPartsVerifications", b =>
                {
                    ...
                    b.HasOne("EtisiqueApi.Models.RequestsCommonParts", "Request")
                        .WithOne("CommonPartsVerifications")
                        .HasForeignKey("EtisiqueApi.Models.CommonPartsVerifications", "RequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EtisiqueApi.Models.Complaint", b =>
                {
                    b.HasOne("EcommercePro.Models.ApplicationUser", "Client")
                        .WithMany()
                    ...
                    b.HasOne("EcommercePro.Models.ApplicationUser", "TransferredTo")
                        .WithMany()
            ...
            modelBuilder.Entity("EtisiqueApi.Models.Emergency", b =>
                {
                    ...
                    b.HasOne("EtisiqueApi.Models.EmergencyTypes", "EmergencyTypes")
                        .WithMany()
            ...
            modelBuilder.Entity("EtisiqueApi.Models.Questionnaire", b =>
                {
                    b.HasOne("EcommercePro.Models.ApplicationUser", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId");
            ...
            modelBuilder.Entity("EtisiqueApi.Models.RequestsImages", b =>
                {
                    ...
                    b.HasOne("EtisiqueApi.Models.Emergency", null)
                        .WithMany("images")
                        .HasForeignKey("Emergencyid");

                    b.HasOne("EtisiqueApi.Models.KitchenServices", null)
                        .WithMany("images")
                        .HasForeignKey("KitchenServicesid");
            ...
            modelBuilder.Entity("EtisiqueApi.Models.TechnicianQusetions", b =>
                {
                    ...
                    b.HasOne("EtisiqueApi.Models.Questionnaire", "questionnaire")
                        .WithMany("TechnicianQusetions")
            ...
            modelBuilder.Entity("EtisiqueApi.Models.ApartmentServicesRequest", b =>
                {
                    b.Navigation("ApartmentServicesVerifications");
            ...
            modelBuilder.Entity("EtisiqueApi.Models.Questionnaire", b =>
                {
                    b.Navigation("TechnicianQusetions");
                });
            ...
            modelBuilder.Entity("EtisiqueApi.Models.RequestsCommonParts", b =>
                {
                    b.Navigation("CommonPartsVerifications");
